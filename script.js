const cards=[
 {bank:"HDFC",name:"HDFC Bank Credit Card",sub:"Demo offer — rewards & everyday spending",fee:"₹0* / year",tag:"Annual Fee",reward:"Rewards",url:"https://gromo.in"},
 {bank:"ICICI",name:"ICICI Bank Credit Card",sub:"Demo offer — shopping & lifestyle",fee:"₹0* / year",tag:"Annual Fee",reward:"Cashback",url:"https://icicibank.com"},
 {bank:"AXIS",name:"Axis Bank Credit Card",sub:"Demo offer — travel & dining",fee:"₹0* / year",tag:"Annual Fee",reward:"Benefits",url:"https://axisbank.com"}
];
const loans=[
 {bank:"HDFC",name:"HDFC Bank Personal Loan",sub:"Demo offer — unsecured personal finance",fee:"From 10.5%*",tag:"Indicative APR",reward:"Flexible",url:"https://hdfcbank.com"},
 {bank:"ICICI",name:"ICICI Bank Personal Loan",sub:"Demo offer — online application",fee:"From 10.8%*",tag:"Indicative APR",reward:"Digital",url:"https://icicibank.com"},
 {bank:"AXIS",name:"Axis Bank Personal Loan",sub:"Demo offer — quick application",fee:"From 11%*",tag:"Indicative APR",reward:"Online",url:"https://axisbank.com"}
];
